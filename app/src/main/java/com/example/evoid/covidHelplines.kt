                ...
                spinner.onItemSelectedListener = object :
                    ...
                    override fun onItemSelected(
                        ...
                        when(spinner.selectedItemId)
                        {
                            ...
                            spinner.getItemIdAtPosition(16)-> covidDisp.text = "102"
                            spinner.getItemIdAtPosition(17)-> covidDisp.text = "7005539653"
                            spinner.getItemIdAtPosition(18)-> covidDisp.text = "9439994859"
                            spinner.getItemIdAtPosition(19)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(20)-> covidDisp.text = "0141-2225624"
                            spinner.getItemIdAtPosition(21)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(22)-> covidDisp.text = "044-29510500"
                            spinner.getItemIdAtPosition(23)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(24)-> covidDisp.text = "0381-2315879"
                            spinner.getItemIdAtPosition(25)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(26)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(27)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(28)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(29)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(30)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(31)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(32)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(33)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(34)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(35)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(36)-> covidDisp.text = "104"
                            spinner.getItemIdAtPosition(37)-> covidDisp.text = "104"
                        }
