...
class faqs : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val one="<b><i>Q: How Does This App Work?</i></b> <br> A:This App Provied Yous With Features To Contact Emergency Service With Just A Tap. If Panic Button Is Pressed, Your Emergency Contacts Will Receive An Alert With Your Location. Please Note That Your Location Is Being Stored To Our Database While This App Is Active To Provide Accurate Results. You Can Also View Guidelines To Protect Yourself In Case Of Emergency.<br><br>" +
