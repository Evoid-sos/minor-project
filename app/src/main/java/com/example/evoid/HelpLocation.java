...
public class HelpLocation extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onLocationChanged(Location location) {
        ...
        switch(v.getId())
        {
            case R.id.hospitalHelp:
                ...
                Toast.makeText(HelpLocation.this, "Showing Nearby hospitals", Toast.LENGTH_SHORT).show();
                break;
            case R.id.policeHelp:
                mMap.clear();
                String policeStation = "police_station";
                url = getUrl(latitude, longitude, policeStation);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(HelpLocation.this, "Showing Nearby Police Station", Toast.LENGTH_SHORT).show();
                break;
            case R.id.fireHelp:
                mMap.clear();
                ...
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(HelpLocation.this, "Showing Nearby Fire Stations", Toast.LENGTH_SHORT).show();
                break;
            case R.id.oldageHelp:
                mMap.clear();
                String oldagehome = "old_age_home";
                url = getUrl(latitude, longitude, oldagehome);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(HelpLocation.this, "Showing Nearby Old Age Homes", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        Log.d("MapMainActivity", "url = "+googlePlaceUrl.toString());
